public class Points{
    ...
    public static void main(String[] args) {
        ...
        points -= 50;
        System.out.println("Harry was caught being cheeky in class. -3 points for Gryffindor");
        points -= 3;
        System.out.println("Hermione got full makrs on Lockhart's quiz. 30 Points for Gryffindor");
        points += 30;
